  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested url" do
        ...
        Url.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => url.to_param, :url => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the url as @url" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Url.any_instance.stub(:save).and_return(false)
        put :update, {:id => url.to_param, :url => {  }}, valid_session
        assigns(:url).should eq(url)
      end
